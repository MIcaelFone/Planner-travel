...
return (
    <div>
        ...
        <div className="mt-5 text-center justify-center items-center">
            <p className="text-sm font-bold ml-20">
                <center>Ao planejar sua viagem pela plann.er você automaticamente concorda <br />
                com nossos <span className="text-gray-500">termos de uso</span> e <span className="text-gray-500">políticas de privacidade.</span> </center>
            </p>
        </div>       
    </div>
)};
